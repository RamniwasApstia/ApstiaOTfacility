    ...
    <div class="col form-background p-3">
        <div class="card mx-auto" style="width: 80%;">
            <div class="card-body">
                ...
                <form action="{{route('OT.update')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3 row">
                        <div class="col-md-12 mt-3">
                        <input class="form-control" type="hidden" value="{{isset($data->OT_number) ? $data->id : null}}"  name="id" > 
                                <lable class="required" >OT Number</lable>
                                <input class="form-control" type="text" value="{{isset($data->OT_number) ? $data->OT_number : null}}"  placeholder="Enter OT number " name="ot_number" required> 
                                <span class="text-danger"> @error('ot_number') {{$message}}  @enderror  </span>
                        </div>  
                       
                        <div class="col-md-12 mt-3" >
                                <lable class="required">Price</lable>
                                <input class="form-control" type="text" value="{{isset($data->OT_price) ? $data->OT_price : null}}" placeholder="Enter Price" name="ot_price" required>
