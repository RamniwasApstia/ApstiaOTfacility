                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-md-12 text-start">
                                    ...
                                    <a href="{{route('OT.add')}}" class="btn cwc-btn-primary waves-effect waves-light bx bx-plus-medical">Add</a>
                                </div>
                            </div>
                            <table id="OT" class="table-bordered dt-responsive table-striped w-100">
...
<script>
    ...
    var delete_url = "{{route('OT.delete')}}";
    var OTturl = "{{route('OT.ajaxlist')}}";
</script>

<!-- data show using ajax -->
<script>        
    $(document).ready(function() {
        var table = $('#OT').DataTable({
            "pageLength": 20,
            "order": [],
            "ajax": {
                "url": OTturl,
...
<script>
    // Ajax Delete
    $(document).on('click','#deleteOT',function () {
        var id = $(this).data('id');
        Swal.fire({
            title: "Are you sure?",
